    ...
    <div class="mb-2 px-1">
      ...
      <input
        ...
        class="${state.archive.password
          ? ''
          : 'invisible'} border rounded focus:border-blue-60 leading-normal my-1 py-1 px-2 h-8 dark:bg-grey-60"
        autocomplete="off"
...
module.exports = function(state, emit, archive) {
  const copyOrShare =
    state.capabilities.share || platform() === 'android'
      ? html`
          <button
            class="link-blue self-end flex items-start dark:text-blue-40 dark:hover:text-blue-50 dark:focus:text-blue-50"
            onclick=${share}
            title="Share link"
          >
